alter table card_charge
    add column absorbed_by_balance_anchor boolean not null default false;

comment on column card_charge.absorbed_by_balance_anchor is
    'True when the purchase predates the card balance anchor and is retained only as financial history';
